...
<section>
    <main>
        <div class="container">
            <div class="imagem">
                <img src="{{ asset('imagens/cargo-ship.png') }}" href="/novo_container" alt="Registrar Container" title="Registrar Container">
                <h1>Empresa X</h1>
            </div>
        </div>
        <h2>Novo Container</h2>
        <div>
            <form class="row g-3" method="post" action="/cadastrar_container">
            @csrf
