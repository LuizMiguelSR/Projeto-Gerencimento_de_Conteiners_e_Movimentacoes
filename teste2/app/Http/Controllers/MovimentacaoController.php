...
class MovimentacaoController extends Controller
{
    ...
    public function filtrar_movimentacao_filtrar(Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        $movimentacao = Movimentacao::create([
            ...
            'data_hora_inicio' => $dataMovimentacao['data_hora_inicio'],
            'data_hora_fim' => $dataMovimentacao['data_hora_fim'],
        ]);
